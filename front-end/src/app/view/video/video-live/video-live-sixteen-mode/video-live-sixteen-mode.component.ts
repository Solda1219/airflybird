...
@Component({
  selector: 'app-video-live-sixteen-mode',
  templateUrl: './video-live-sixteen-mode.component.html',
  styleUrls: ['./video-live-sixteen-mode.component.scss']
})
export class VideoLiveSixteenModeComponent implements OnInit {
