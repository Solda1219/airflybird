...
@Component({
  selector: 'app-report-online-content',
  templateUrl: './report-online-content.component.html',
  styleUrls: ['./report-online-content.component.scss']
})
export class ReportOnlineContentComponent implements OnInit {
  @Input('item') item = [];
  //for mat-table
  tbHeader = ['Device Name', 'IMEI', 'Model','Status','StartTime','Endtime',"Duration"];
  tbCol = ['device_name', 'imei', 'model','status','start_time','end_time',"duration"];
  displayedColumns: string[] = ['select','device_name', 'imei', 'model','status','start_time','end_time',"duration"];
