...
@Component({
  selector: 'app-report-alert-detail-content',
  templateUrl: './report-alert-detail-content.component.html',
  styleUrls: ['./report-alert-detail-content.component.scss']
})
export class ReportAlertDetailContentComponent implements OnInit {
  @Input('item') item = [];
  //for mat-table
