...
@Component({
  selector: 'app-report-parking-content',
  templateUrl: './report-parking-content.component.html',
  styleUrls: ['./report-parking-content.component.scss']
})
export class ReportParkingContentComponent implements OnInit {
  @Input('item') item = [];
  //for mat-table
