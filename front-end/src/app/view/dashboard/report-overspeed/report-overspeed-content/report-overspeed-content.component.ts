...
@Component({
  selector: 'app-report-overspeed-content',
  templateUrl: './report-overspeed-content.component.html',
  styleUrls: ['./report-overspeed-content.component.scss']
})
export class ReportOverspeedContentComponent implements OnInit {
  @Input('item') item = [];
  //for mat-table
  tbHeader = ['Device Name', 'IMEI', 'Model','Status','StartTime','Endtime',"Duration",'Location started','Location ended'];
  tbCol = ['device_name', 'imei', 'model','status','start_time','end_time',"duration",'start_address','end_address'];
  displayedColumns: string[] = ['select','device_name', 'imei', 'model','status','start_time','end_time',"duration",'start_address','end_address'];
