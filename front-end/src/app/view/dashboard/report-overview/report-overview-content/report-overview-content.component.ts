...
@Component({
  selector: 'app-report-overview-content',
  templateUrl: './report-overview-content.component.html',
  styleUrls: ['./report-overview-content.component.scss']
})
export class ReportOverviewContentComponent implements OnInit {
  @Input('item') item = [];
  //for mat-table
  tbHeader = ['Device Name', 'IMEI', 'Model','TotalMile(km)','Overspeed','Stopover'];
  tbCol = ['device_name', 'imei', 'model','total_mile','overspeed','stopover'];
  displayedColumns: string[] = ['select','device_name', 'imei', 'model','total_mile','overspeed','stopover'];
