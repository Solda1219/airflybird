...
@Component({
  selector: 'app-report-alert-content',
  templateUrl: './report-alert-content.component.html',
  styleUrls: ['./report-alert-content.component.scss']
})
export class ReportAlertContentComponent implements OnInit {
  @Input('item') item = [];
  //for mat-table
  tbHeader = ['Device Name', 'IMEI', 'Account', 'Alert Type', 'Alert Time'];
  tbCol = ['device_name', 'imei', 'account', 'alertTypeName', 'postTime'];
  displayedColumns: string[] = ['select','device_name', 'imei', 'account', 'alertTypeName', 'postTime'];
