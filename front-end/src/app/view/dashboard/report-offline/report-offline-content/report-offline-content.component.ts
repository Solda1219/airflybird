...
@Component({
  selector: 'app-report-offline-content',
  templateUrl: './report-offline-content.component.html',
  styleUrls: ['./report-offline-content.component.scss']
})
export class ReportOfflineContentComponent implements OnInit {
  @Input('item') item = [];
  //for mat-table
  tbHeader = ['Device Name', 'IMEI', 'Model','Status','StartTime','Endtime',"Duration","Address"];
  tbCol = ['device_name', 'imei', 'model','status','start_time','end_time',"duration","start_address"];
  displayedColumns: string[] = ['select','device_name', 'imei', 'model','status','start_time','end_time',"duration","start_address"];
