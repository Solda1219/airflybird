...
@Component({
  selector: 'app-report-idling-content',
  templateUrl: './report-idling-content.component.html',
  styleUrls: ['./report-idling-content.component.scss']
})
export class ReportIdlingContentComponent implements OnInit {
  @Input('item') item = [];
  //for mat-table
